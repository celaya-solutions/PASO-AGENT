---
summary: "How to contribute to the PASO threat model"
...
<Note>
This is for adding to the threat model, not reporting live vulnerabilities. If you found an exploitable vulnerability, follow the private disclosure instructions in the repository's [security policy](https://github.com/celaya-solutions/PASO-AGENT/blob/main/SECURITY.md) instead.
</Note>

## Ways to contribute

**Add a threat.** Open a [documentation issue](https://github.com/celaya-solutions/PASO-AGENT/issues/new?template=docs_bug_report.yml) describing the attack scenario in your own words. Helpful but not required:
...
- **Security vulnerabilities:** use a private [GitHub Security Advisory](https://github.com/celaya-solutions/PASO-AGENT/security/advisories/new), or email `hello@celayasolutions.com` with the subject `Private PASO security report` if private reporting is unavailable.
- **Threat model questions:** open a [documentation issue](https://github.com/celaya-solutions/PASO-AGENT/issues/new?template=docs_bug_report.yml).
- **General chat:** Discord `#security` channel.

## Recognition

Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the PASO security hall of fame for significant contributions.
