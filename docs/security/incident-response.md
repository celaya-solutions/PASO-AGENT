---
summary: "How PASO triages, responds to, and follows up on security incidents"
...
| High     | Verified trust-boundary bypass requiring limited preconditions (for example, authenticated but unauthorized high-impact action), or exposure of PASO-owned sensitive credentials. |
...
- [Security policy](https://github.com/celaya-solutions/PASO-AGENT/blob/main/SECURITY.md) — report scope and trust model.
