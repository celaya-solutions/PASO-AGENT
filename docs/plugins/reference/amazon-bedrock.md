---
summary: "PASO Amazon Bedrock provider plugin with model discovery, embeddings, and guardrail support."
read_when:
...
PASO Amazon Bedrock provider plugin with model discovery, embeddings, and guardrail support.
