---
summary: "Adds the Clickclack channel surface for sending and receiving PASO messages."
read_when:
...
Adds the Clickclack channel surface for sending and receiving PASO messages.
...
for each PASO session. Managed discussion channels use a same-agent side
