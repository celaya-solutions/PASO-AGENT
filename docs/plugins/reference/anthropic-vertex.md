---
summary: "PASO Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
PASO Anthropic Vertex provider plugin for Claude models on Google Vertex AI.
...
`/think off` or the native `/think xhigh|max` levels. PASO publishes its
