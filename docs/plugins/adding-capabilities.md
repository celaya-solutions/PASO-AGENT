---
summary: "Contributor guide for adding a new shared capability to the PASO plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for PASO core developers. If you are
...
Use this when PASO needs a new shared domain such as embeddings, image
