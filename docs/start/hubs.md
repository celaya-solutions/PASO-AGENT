---
summary: "Hubs that link to every PASO doc"
read_when:
...
<Note>
If you are new to PASO, start with [Getting Started](/start/getting-started).
</Note>
...
- [PASO assistant](/start/personal-assistant)
- [PASO use cases](/start/showcase)
- [PASO identity](/start/lore)
