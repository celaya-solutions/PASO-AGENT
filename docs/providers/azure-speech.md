---
summary: "Azure AI Speech text-to-speech for PASO replies"
read_when:
...
Azure Speech is a bundled Azure AI Speech text-to-speech provider. PASO
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. PASO synthesizes the audio
...
<AccordionGroup>
  <Accordion title="Authentication">
    ...
    is sent as `Ocp-Apim-Subscription-Key`; PASO derives
  ...
  <Accordion title="Audio outputs">
    ...
    `ogg-24khz-16bit-mono-opus`, and `riff-24khz-16bit-mono-pcm`. PASO
