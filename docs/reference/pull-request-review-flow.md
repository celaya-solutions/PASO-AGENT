---
summary: "How Barnacle and ClawSweeper feedback helps move PASO pull requests through review."
read_when:
...
This page explains the review flow after you open or update a PASO pull
...
ClawSweeper is the AI-assisted review and maintenance bot for PASO
...
PASO also uses separate stale automation. Unassigned issues and PRs can be
...
- [Contributing](https://github.com/celaya-solutions/PASO-AGENT/blob/main/CONTRIBUTING.md)
- [CI pipeline](/ci)
