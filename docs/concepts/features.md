---
summary: "PASO capabilities across channels, routing, media, and UX."
read_when:
  - You want a full list of what PASO supports
title: "Features"
---
...
- External plugin channels maintained outside the PASO repo: WeChat, Yuanbao, and Zalo ClawBot
...
<CardGroup cols={2}>
  ...
  <Card title="Plugins" href="/tools/plugin" icon="plug">
    Official and external plugins that extend PASO.
  </Card>
</CardGroup>
