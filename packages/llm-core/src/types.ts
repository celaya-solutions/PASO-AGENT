...
/** Provider API families with first-class request/stream adapters in PASO. */
...
/** Image-generation API families with first-class adapters in PASO. */
...
/** Image provider ids with first-class adapters in PASO. */
...
export interface UserMessage {
   ...
   * (e.g. a PASO runtime-context carrier appended after the active user
