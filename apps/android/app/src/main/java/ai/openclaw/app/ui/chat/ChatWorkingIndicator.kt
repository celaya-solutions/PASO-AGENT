...
private fun localizedWorkingPhrase(index: Int): String =
  when (index) {
    0 -> nativeStringResource("Progressing")
    1 -> nativeStringResource("Thinking")
    2 -> nativeStringResource("Planning")
    3 -> nativeStringResource("Researching")
    4 -> nativeStringResource("Reading")
    5 -> nativeStringResource("Checking")
    6 -> nativeStringResource("Connecting")
    7 -> nativeStringResource("Organizing")
    8 -> nativeStringResource("Drafting")
    9 -> nativeStringResource("Reviewing")
    10 -> nativeStringResource("Refining")
    11 -> nativeStringResource("Analyzing")
    12 -> nativeStringResource("Preparing")
    13 -> nativeStringResource("Processing")
    14 -> nativeStringResource("Working")
    15 -> nativeStringResource("Composing")
    16 -> nativeStringResource("Summarizing")
    17 -> nativeStringResource("Finishing")
    18 -> nativeStringResource("Responding")
