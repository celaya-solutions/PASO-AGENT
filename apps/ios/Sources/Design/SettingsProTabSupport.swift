...
enum SettingsNotificationPresentation: Equatable {
    ...
    var detail: String {
        ...
        case .enabled:
            String(
                localized: "PASO can show approval prompts and event alerts when the app is not active.")
        case .off:
            String(localized: "PASO notifications are off.")
        case .setup:
            String(
        ...
        case .unknown:
            String(localized: "PASO cannot determine the current notification permission state.")
        }
    }
