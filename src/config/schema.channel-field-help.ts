...
const SHARED_CHANNEL_FIELD_HELP: Record<string, string> = {
  ...
  capabilities: "Override the channel capabilities PASO assumes this account supports.",
  ...
  textChunkLimit: "Maximum characters per outbound message before PASO splits it.",
