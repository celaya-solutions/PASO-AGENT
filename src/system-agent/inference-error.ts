...
const INFERENCE_UNAVAILABLE_MESSAGE =
  "PASO could not reach working inference. Run `openclaw onboard` on the machine running PASO to reconnect — it live-tests the route before saving it. Then try again.";
...
/** Safe public error for a PASO turn that could not complete with intelligence. */
