...
const DEFAULT_TAGLINE = "All your chats, one PASO.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—your assistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your agent is ready—type something and let PASO handle the busywork.",
  ...
  "Gateway online—your next task has a clear path forward.",
  ...
  "Practical automation: minimal fuss, useful results.",
  ...
  "Plan ready, commit clean—let's ship something responsible.",
  "I can turn a messy workflow into a clear set of steps.",
  "I'm here to handle the toil and leave you the useful work.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The AI agent in your contacts that can actually take the next step.",
  ...
  "Built in El Paso for people who want useful AI work.",
  ...
  "Open source, inspectable, and ready to adapt to your work.",
  ...
  "Half coordinator, half debugger, fully focused on the task.",
  ...
  "A practical agent in your shell.",
  "Alexa, but with taste.",
  "I'm not AI-powered, I'm AI-possessed. Big difference.",
  "You had me at 'openclaw gateway start.'",
  "Fresh shell, same goal—small steps still move the work forward.",
  "Fork-friendly and built to keep moving.",
  "A clear detour can still be the right path forward.",
  ...
  "PASO Support will never DM you first. I, on the other hand, absolutely will.",
  ...
  "PASO: an AI agent by Celaya Solutions Research.",
  ...
  "Primary model down, fallback engaged: the work keeps moving.",
