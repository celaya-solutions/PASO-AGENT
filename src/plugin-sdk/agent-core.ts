...
/** Runtime adapter that lets the package agent-core use PASO LLM helpers. */
...
/** Agent-core class preconfigured with PASO runtime dependencies. */
...
// PASO-owned reusable agent core
