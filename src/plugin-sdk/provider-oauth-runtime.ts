...
// Static PASO path mark; keep shapes in sync with ui/public/favicon.svg.
const LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none" aria-hidden="true"><rect width="64" height="64" rx="14" fill="#0E1015"/><path d="M18 50V14H36C44.837 14 52 21.163 52 30C52 38.837 44.837 46 36 46H30" stroke="#E8590C" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/><path d="M18 50H28V40H38V30H50" stroke="#FAF9F7" stroke-width="5" stroke-linecap="square" stroke-linejoin="miter"/></svg>`;
