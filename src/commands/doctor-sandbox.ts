...
async function noteCodexBwrapNamespaceWarning(
  ...
  const lines = [
    ...
    "",
    "Fix the host namespace policy for the PASO service user, then restart the gateway.",
    "Prefer an AppArmor profile that grants the required namespaces to the PASO service process.",
