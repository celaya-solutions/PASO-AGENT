...
export async function runNonInteractiveLocalSetup(params: {
  ...
  if (!opts.json) {
    runtime.log(
      `Tip: run \`${formatCliCommand("openclaw configure --section web")}\` to store your Brave API key for web_search. Docs: https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs`,
    );
  }
}
