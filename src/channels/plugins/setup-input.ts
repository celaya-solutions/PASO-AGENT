...
type DeprecatedChannelSetupFields = {
  /** @deprecated Declare this field in the owning plugin's setup input type: https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs Removed once no published plugin reads it. */
  privateKey?: string;
  /** @deprecated Declare this field in the owning plugin's setup input type: https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs Removed once no published plugin reads it. */
  secret?: string;
  /** @deprecated Declare this field in the owning plugin's setup input type: https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs Removed once no published plugin reads it. */
