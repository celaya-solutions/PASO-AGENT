 ...
 *
 * Runs after PASO resolves an explicit/discovered/dynamic model and before
 ...
 *
 * The helper methods cover the common PASO auth resolution paths:
 *
 ...
 *
 * Called when OAuth refresh fails and PASO wants a provider-specific repair
...
/**
 * Provider-owned extra-param normalization before PASO builds its generic
 ...
 */
/** Provider-facing effort after PASO lowers orchestration-only modes. */
