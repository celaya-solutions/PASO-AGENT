...
describe("loadPluginManifestRegistry", () => {
  ...
  it.each([
    {
      ...
      expectedMessage: "plugin requires PASO >=2026.3.22, but this host is 2026.3.21",
      expectWarn: true,
    },
    {
      ...
      expectedMessage: "plugin requires PASO >=2026.5.1-beta.1, but this host is 2026.4.30",
      expectWarn: true,
    },
    {
  ...
  it("does not runtime-gate bundled source plugins by install minHostVersion", () => {
    ...
    expectNoRegistryDiagnosticContains(registry, "requires PASO");
  });
