  ...
  const execTool = markCodeModeControlTool({
    ...
    parameters: Type.Object({
      ...
      restartSafe: Type.Optional(
        Type.Boolean({
          description:
            "Do not set on a new exec. Set true only when PASO explicitly requests replay after a gateway restart; never for write, edit, exec, or any mutation. True rejects unmarked or namespace surfaces.",
        }),
      ),
    }),
    execute: async (
