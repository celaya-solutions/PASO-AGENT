...
describe("detectImageReferences", () => {
  ...
  it("ignores PASO CLI image cache paths from prior prompt transcripts", () => {
  ...
  it("ignores temporary PASO CLI image cache paths", () => {
  ...
  it("ignores file URLs into the PASO CLI image cache", () => {
