 ...
 *
 * Wraps pi-tui keybindings with PASO-specific actions and per-agent overrides.
 */
...
/** PASO-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Keybinding manager that loads PASO defaults plus optional user overrides. */
