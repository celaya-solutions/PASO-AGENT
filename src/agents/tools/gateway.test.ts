...
describe("gateway tool defaults", () => {
  ...
  it("explains stale gateway cron connection metadata rejections", async () => {
    ...
    await expect(
      ...
      "The running Gateway is from an older PASO build and rejected current agent runtime connection metadata. Restart the Gateway with `openclaw gateway restart`, then retry.",
    );
