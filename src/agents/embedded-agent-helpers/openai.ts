 ...
 * pairs directly into the provider payload, so PASO must normalize here.
 */
 ...
 *
 * PASO persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
