...
export const zh_TW = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "直接把密碼存入 PASO 設定",
      ...
      tokenStoreProvisioned:
        "已產生 Gateway 權杖並以 {name} 存入 PASO 祕密儲存。設定中只保留參照；可用 `openclaw secrets store list` 檢視。",
    ...
    memoryImport: {
      ...
      confirm: "將這些 memory 匯入你的 PASO 工作區？",
    ...
    remote: {
      ...
      plaintextPasswordHint: "直接把密碼存入 PASO 設定",
      plaintextPasswordLabel: "現在輸入密碼",
      plaintextTokenHint: "直接把權杖存入 PASO 設定",
    ...
    guided: {
      ...
      custodianIntro: "你好 — 我是 PASO，負責維護這套系統。我們開始設定吧。",
      ...
      appliedTitle: "推理已就緒",
      complete: "PASO 已準備就緒。",
      completeWithoutAi: "PASO 設定已儲存。連接 AI 後再開啟聊天。",
      detected: "AI 偵測完成。",
      ...
      intro: "連接你的 AI",
      invalidConfigDetails: "PASO 設定 {path} 無效：\n{issues}",
      invalidConfigRepair:
    ...
    security: {
      ...
      attribution: "PASO 是由 PASO 基金會（非營利組織）開發的開源助手，會與你一同學習成長。",
      baselineDmSessions:
      ...
      confirm: "我理解 PASO 預設面向個人使用；共享/多使用者使用需要加固。繼續？",
      hardeningRequired: "如果你不熟悉存取控制和安全加固，請在獲得協助前不要執行 PASO。",
      learnMore: "了解更多請參閱",
      notMultitenant: "預設情況下，PASO 並非旨在安全地隔離多個使用者。",
      personalAgent: "預設情況下，PASO 是供一位操作者使用的個人 agent。",
    ...
    skills: {
      ...
      docsLine: "文件：https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs",
      enterEnv: "輸入 {env}",
    ...
    clickclack: {
      ...
      helpCreateToken: "在 ClickClack 中：工作區設定 → Integrations → PASO → 建立 bot → 複製 token",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) 執行：./occ talk:bot:install "PASO" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "需要傳送者/擁有者號碼，以便 PASO 將你加入允許清單。",
      ...
      separatePhoneLabel: "PASO 專用獨立手機",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "這是 PASO 用來向 Chat 傳送回覆的 URL。",
      ...
      publicWebhookUrlScope: "僅公開此 webhook 路由；PASO 使用它提供短期附件下載。",
    ...
    signal: {
      ...
      multipleEntries: "多個項目請用逗號分隔。",
      nextLinkDevice: '綁定裝置：signal-cli link -n "PASO"',
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "將 Synology NAS Chat 連接到 PASO，並啟用完整 agent 能力。",
    ...
    finalize: {
      ...
      controlUiDocs: "文件：https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs",
      dashboardCopyPaste: "在本機瀏覽器中複製/貼上這個 URL 來控制 PASO。",
      dashboardOpened: "已在瀏覽器中開啟。保留該分頁以控制 PASO。",
      ...
      optionalApps: "可選應用",
      outroDashboardLink: "Onboarding 完成。使用上面的 dashboard 連結控制 PASO。",
      outroDashboardOpened: "Onboarding 完成。Dashboard 已開啟；保留該分頁以控制 PASO。",
      ...
      containerSystemdUnavailable:
        "此容器內沒有 systemd 使用者服務。PASO 只會略過背景服務安裝；請以前景方式執行 Gateway，或使用你的容器 supervisor。",
      securityReminder:
        "在你的電腦上執行 agent 存在風險，請加固設定：https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs",
      ...
      webDocs: "文件：https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs",
      ...
      webUiUrl: "Web UI：{url}",
      whatNow: "下一步：https://github.com/celaya-solutions/PASO-AGENT。",
      whatNowTitle: "下一步",
      workspaceBackupTitle: "工作區備份",
      workspaceDocs: "文件：https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs",
