...
export const zh_CN = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "直接把密码存入 PASO 配置",
      ...
      tokenStoreProvisioned:
        "已生成 Gateway 令牌并以 {name} 存入 PASO 密钥存储。配置中只保留引用；可用 `openclaw secrets store list` 查看。",
    ...
    memoryImport: {
      ...
      confirm: "将这些 memory 导入你的 PASO 工作区？",
    ...
    remote: {
      ...
      plaintextPasswordHint: "直接把密码存入 PASO 配置",
      plaintextPasswordLabel: "现在输入密码",
      plaintextTokenHint: "直接把令牌存入 PASO 配置",
    ...
    guided: {
      ...
      custodianIntro: "你好 — 我是 PASO，负责维护这套系统。我们开始设置吧。",
      ...
      appliedTitle: "推理已就绪",
      complete: "PASO 已准备就绪。",
      completeWithoutAi: "PASO 设置已保存。连接 AI 后再打开聊天。",
      detected: "AI 检测完成。",
      ...
      intro: "连接你的 AI",
      invalidConfigDetails: "PASO 配置 {path} 无效：\n{issues}",
      invalidConfigRepair:
    ...
    security: {
      ...
      attribution: "PASO 是由 PASO 基金会（非营利组织）开发的开源助手，会与你一同学习成长。",
      baselineDmSessions:
      ...
      confirm: "我理解 PASO 默认面向个人使用；共享/多用户使用需要加固。继续？",
      hardeningRequired: "如果你不熟悉访问控制和安全加固，请在获得帮助前不要运行 PASO。",
      learnMore: "了解更多请访问",
      notMultitenant: "默认情况下，PASO 并非旨在安全地隔离多个用户。",
      personalAgent: "默认情况下，PASO 是供一位操作员使用的个人 agent。",
    ...
    skills: {
      ...
      docsLine: "文档：https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs",
      enterEnv: "输入 {env}",
    ...
    clickclack: {
      ...
      helpCreateToken: "在 ClickClack 中：工作区设置 → Integrations → PASO → 创建 bot → 复制 token",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) 运行：./occ talk:bot:install "PASO" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "需要发送者/所有者号码，以便 PASO 将你加入允许列表。",
      ...
      separatePhoneLabel: "PASO 专用独立手机",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "这是 PASO 用来向 Chat 发送回复的 URL。",
      ...
      publicWebhookUrlScope: "仅公开此 webhook 路由；PASO 使用它提供短期附件下载。",
    ...
    signal: {
      ...
      multipleEntries: "多个条目请用逗号分隔。",
      nextLinkDevice: '绑定设备：signal-cli link -n "PASO"',
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "将 Synology NAS Chat 连接到 PASO，并启用完整 agent 能力。",
    ...
    finalize: {
      ...
      controlUiDocs: "文档：https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs",
      dashboardCopyPaste: "在本机浏览器中复制/粘贴这个 URL 来控制 PASO。",
      dashboardOpened: "已在浏览器中打开。保留该标签页以控制 PASO。",
      ...
      optionalApps: "可选应用",
      outroDashboardLink: "Onboarding 完成。使用上面的 dashboard 链接控制 PASO。",
      outroDashboardOpened: "Onboarding 完成。Dashboard 已打开；保留该标签页以控制 PASO。",
      ...
      containerSystemdUnavailable:
        "此容器内没有 systemd 用户服务。PASO 只会跳过后台服务安装；请以前台方式运行 Gateway，或使用你的容器 supervisor。",
      securityReminder:
        "在你的电脑上运行 agent 存在风险，请加固设置：https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs",
      ...
      webDocs: "文档：https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs",
      ...
      workspaceDocs: "文档：https://github.com/celaya-solutions/PASO-AGENT/tree/main/docs",
