---
name: healthcheck
description: "Audit and harden PASO hosts: SSH, firewall, updates, exposure, backups, disk encryption, and Gateway security."
---

# PASO host healthcheck
...
- Never claim PASO manages OS firewall, SSH, or updates.
...
- PASO Gateway status, bind, and auth.
- Backup status.
- Disk encryption.
