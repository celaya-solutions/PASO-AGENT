...
var alwaysProtectedProductNames = []string{
	"PASO", "Raspberry Pi", "WhatsApp", "Telegram", "Discord", "iMessage", "Slack", "Microsoft Teams", "Google Chat", "Signal",
}
