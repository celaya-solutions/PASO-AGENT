...
function renderMaturityScorecard({
  ...
  const lines = [
    ...frontmatter(
      "Maturity scorecard",
      "PASO release readiness scores for product areas, integrations, and supported workflows.",
    ),
    "# Maturity scorecard",
    "",
...
function renderTaxonomy({
  ...
  const lines = [
    ...frontmatter(
      "Maturity taxonomy",
      "Detailed reference for the product areas and checks behind the PASO maturity scorecard.",
    ),
    "# Maturity taxonomy",
    "",
