...
REMOTE_URL="${OPENCLAW_REF_REMOTE:-https://github.com/celaya-solutions/PASO-AGENT.git}"
REF=""
EXPECTED_SHA=""
FALLBACK_OK=0
...
Fast-resolves PASO branch and tag refs with git ls-remote. Full commit SHAs
...
echo "Failed to resolve PASO ref: ${REF}" >&2
exit 1
