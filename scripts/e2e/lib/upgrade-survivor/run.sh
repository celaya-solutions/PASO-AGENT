...
validate_baseline_package_spec() {
  ...
  echo "OPENCLAW_UPGRADE_SURVIVOR_BASELINE must be openclaw@latest, openclaw@beta, openclaw@alpha, an exact PASO release version, or a bare release version; got: $spec" >&2
  return 1
}
