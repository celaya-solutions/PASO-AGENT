...
function seedInstallState() {
  ...
  const index = {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by PASO plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("PASO will continue without it")
  );
}
