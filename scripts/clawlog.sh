...
show_usage() {
    cat << EOF
clawlog - PASO Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View PASO logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    PASO logs flow through the macOS unified log (subsystem: ai.openclaw).
