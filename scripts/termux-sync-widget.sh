...
# PASO OAuth Sync Widget
# Syncs Claude Code tokens to PASO over SSH
# Place in ~/.shortcuts/ on phone for Termux:Widget

termux-toast "Syncing PASO auth..."

# Run sync on the configured PASO host.
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    termux-toast "PASO synced! Expires:${EXPIRY}"
