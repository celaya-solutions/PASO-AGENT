...
describe("web logout", () => {
  ...
  it("does not delete through symlinked auth dirs inside the PASO auth root", async () => {
  ...
  it("does not delete through intermediate symlinks inside the PASO auth root", async () => {
