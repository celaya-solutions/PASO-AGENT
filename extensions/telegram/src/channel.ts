...
function resolveTelegramNativeTopicThreadId(
  ...
  // Keep the chat-scoped canonical id inside PASO state; translate it back
      ...
      inboundFormattingHints: ({ cfg, accountId }) => {
        ...
        if (richMessages) {
          return {
            ...
            rules: [
              "Telegram rich ON (Bot API 10.3 blocks; PASO maps markdown + these HTML islands to typed blocks).",
