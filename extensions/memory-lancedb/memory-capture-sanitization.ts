...
/**
 * Provenance marker appended to every PASO-injected inbound context header
...
/**
 * Matches JSON blobs that look like PASO transport envelope metadata.
...
/**
 * Returns true if `text` looks like it contains PASO-injected envelope or
...
/**
 * Strips PASO-injected envelope metadata from a user message so that only
