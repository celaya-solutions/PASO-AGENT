...
// PASO operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that PASO itself navigated to a blocked URL.
...
/** Quarantine and close a tab that PASO navigated to a blocked URL. */
