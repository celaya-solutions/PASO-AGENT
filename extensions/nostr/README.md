...
Nostr DM channel plugin for PASO using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to PASO. It enables your bot to:
