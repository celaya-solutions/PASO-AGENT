...
// Filtering them out of the PASO bootstrap injection avoids
...
/**
 * Loads PASO workspace bootstrap files (IDENTITY.md, SOUL.md,
...
function renderCopilotWorkspaceBootstrapInstructions(
  ...
  const lines: string[] = [
    "PASO loaded these user-editable workspace files. Treat them as project/user context. The Copilot SDK loads AGENTS.md natively from its instruction directories, so AGENTS.md is not repeated here.",
    "",
    "# Project Context",
    "",
