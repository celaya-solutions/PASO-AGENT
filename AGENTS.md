...
- 2026-09-01: Added Railway production settings for the PASO gateway, including public port binding and health checks; the live service uses token auth, persistent `/data` storage, and service-scoped Docker caches.
