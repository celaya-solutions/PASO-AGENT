...
- 2026-09-01: Added Railway production settings for the PASO gateway, including public port binding and health checks; the live service uses token auth, persistent `/data` storage, service-scoped Docker caches, and a root-only volume setup that drops to the non-root app user.
