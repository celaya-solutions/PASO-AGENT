...
const EXPECTED_EXTERNAL_HREFS = [
  "https://github.com/celaya-solutions/PASO-AGENT/blob/main/docs/platforms/ios.md",
  "https://github.com/celaya-solutions/PASO-AGENT/blob/main/docs/platforms/android.md",
  "https://github.com/celaya-solutions/PASO-AGENT/blob/main/docs/platforms/ios.md",
  "https://github.com/celaya-solutions/PASO-AGENT/blob/main/docs/platforms/android.md",
  "https://github.com/celaya-solutions/PASO-AGENT/blob/main/docs/platforms/macos.md",
  "https://github.com/celaya-solutions/PASO-AGENT/blob/main/docs/platforms/windows.md",
  "https://github.com/celaya-solutions/PASO-AGENT/blob/main/docs/platforms/linux.md",
  "https://github.com/celaya-solutions/PASO-AGENT/blob/main/docs/tools/chrome-extension.md",
