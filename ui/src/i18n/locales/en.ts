...
export const en: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle: "PASO was updated in the background. Reload to get the latest panel.",
    reloading: "Reloading…",
    retry: "Retry",
  ...
  updates: {
    ...
    confirm: {
      ...
      macMessage:
        "Hands this update to the PASO Mac app, which installs it and restarts the Gateway it manages.",
      impact:
    ...
    page: {
      ...
      channelDescription: "Choose which PASO release track this Gateway follows.",
    ...
    failureReasons: {
      ...
      notOpenclawRoot: "Run the update from a PASO checkout or use the CLI global reinstall path.",
  ...
  devices: {
    ...
    pairing: {
      ...
      qrAlt: "PASO mobile pairing QR code",
      ...
      review: "Review",
      waiting: "Official PASO mobile apps connect automatically after scanning.",
  ...
  worktrees: {
    ...
    subtitle: "Isolated repository checkouts owned by PASO.",
  ...
  sessionsView: {
    ...
    moveSessionNoReplayWarning:
      "PASO safely reconciles the current workspace before moving. Active work is never replayed.",
  ...
  quickSettings: {
    ...
    appearance: {
      lobsterVisits: "Legacy mascot visits",
      lobsterVisitsOn: "Shown occasionally",
      lobsterVisitsOff: "Hidden",
      lobsterSounds: "Legacy mascot sounds",
      lobsterSoundsOn: "Sound enabled",
      lobsterSoundsOff: "Silent",
      lobsterdex: "Legacy mascot gallery",
      ...
      lobsterdexOpen: "Open legacy gallery",
    },
    security: {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint: "Allow PASO in macOS System Settings > Notifications.",
      iosInstallRequired: "On iPhone or iPad, use Share > Add to Home Screen, then open PASO.",
    ...
    appearance: {
      ...
      fonts: {
        ...
        system: "System",
        previewCaption: "PASO · A little clarity goes a long way",
        previewProse:
  ...
  skillsPage: {
    ...
    searchClawHub: "Search registry skills…",
    searching: "Searching…",
    disconnected: "Not connected to gateway.",
    empty: "No skills found.",
    noClawHubResults: "No skills found in the registry.",
    notScannedByClawHub: "Not scanned by the registry",
    install: "Install",
    installed: "Installed",
    ...
    invalidLink: "Registry link invalid",
    overview: "Overview",
  ...
  browser: {
    ...
    navigationCheckFailed: "PASO couldn’t verify this tab’s address. Refresh to try again.",
    title: "Browser",
    open: "Open",
  ...
  subtitles: {
    ...
    lobsterdex: "Legacy mascot palettes stored in this browser.",
  ...
  cloudWorkersPage: {
    ...
    fields: {
      ...
      setup: "Setup command",
      setupHelp: "Optional idempotent shell command run before PASO is installed.",
  ...
  modelSetup: {
    ...
    intro:
      "PASO checks the AI access available on this Gateway and verifies the exact model before it enables conversations.",
    required: {
      title: "No AI provider configured",
      body: "We couldn't find a provider and model configured for this agent. Choose a supported connection; PASO will test it before enabling chat.",
      action: "Connect an AI provider",
    },
    connectionFailure: {
      title: "Configured AI needs attention",
      body: "PASO found the provider and model selected for this agent, but the live check failed. Your configuration is still intact. Review the credential, model access, or provider status, then verify again.",
    ...
    access: {
      ...
      gatewayTooOld: "The Gateway is running an older PASO version",
    },
    candidates: {
    ...
    manual: {
      ...
      verifyHint: "PASO verifies a real model reply before marking the connection ready.",
      required: "Choose a provider and enter an API key or token.",
    },
    success: {
      title: "Connection verified",
      body: "PASO received a real reply from {modelRef}. You can start chatting now.",
  ...
  memoryImport: {
    ...
    confirmBackup: "PASO creates a verified pre-import backup before copying memory.",
    ...
    subtitle:
      "Review Codex consolidated memory and Claude Code auto-memory before copying it into PASO.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "PASO found memory from other coding assistants. Import it into your agent workspace?",
      ...
      doneBody: "Migrated {migrated}, skipped {skipped}. You can continue setting up PASO.",
    },
  },
  assistantPanel: {
  ...
  custodian: {
    ...
    placeholder: "Message PASO…",
    sensitivePlaceholder: "Enter sensitive value…",
    sensitiveReply: "Sensitive reply sent",
    cancel: "Cancel",
    send: "Send",
    thinking: "PASO is thinking",
    earlier: "Earlier",
    requestFailed: "PASO could not reply. Try again.",
    connectionChanged: "The Gateway connection changed. Retry to continue this setup.",
    sessionRestarted: "{error} PASO started a fresh session; earlier messages remain for context.",
    unsupportedGateway: "Update the Gateway to continue setup with PASO.",
    panel: {
      title: "PASO",
      toggle: "Toggle Ask PASO",
      close: "Close Ask PASO",
      resize: "Resize Ask PASO",
      dockBottom: "Dock Ask PASO at bottom",
      dockRight: "Dock Ask PASO at right",
    },
    history: {
      button: "History",
      ...
      requestFailed: "PASO could not load change history.",
      loadMore: "Load more",
    ...
    nudge: {
      ...
      channelSetupTitle: "Reach PASO outside this app",
      channelSetupBody:
        "The web app already works. Add a channel only if you want to message PASO from another service.",
  ...
  mcpPage: {
    intro: "Connect and manage MCP servers that provide tools to PASO.",
    servers: "Servers",
    oauth: "OAuth",
    filtered: "Filtered",
  ...
  memoryPage: {
    intro: "Choose how PASO stores, searches, and maintains agent memory.",
  ...
  pluginsPage: {
    ...
    searchPlaceholder: "Search plugins and the registry",
    browseClawHub: "Browse plugin registry",
    refresh: "Refresh",
    ...
    searching: "Searching plugin registry…",
    fromClawHub: "From plugin registry",
    noClawHubResultsBody: "The plugin registry has no results for “{query}”.",
    ...
    connectorsHint:
      "One-click MCP connectors and hand-picked registry searches for popular services.",
    ...
    connectorClawHubNote: "Community plugins in the registry",
    connectorAdd: "Add",
    connectorSearch: "Find in registry",
    ...
    noInstalledBody: "Discover a featured plugin or search the registry to extend PASO.",
    ...
    optionalCapability: "Optional PASO capability.",
    enabled: "Enabled",
    disabled: "Disabled",
    available: "Available",
  ...
  aboutPage: {
    productName: "PASO",
    tagline: "An AI agent by Celaya Solutions Research.",
    location: "El Paso, TX",
    linksLabel: "Project and contact",
    linkGitHub: "Project source",
    linkEmail: "hello@celayasolutions.com",
    license: "© 2026 Celaya Solutions Research — MIT License.",
  ...
  appsPage: {
    heroTitle: "Take PASO everywhere",
    heroTagline:
    ...
    ctaBrowseClawHub: "Browse plugin registry",
    linkDiscord: "Email Celaya Solutions Research",
    linkDocs: "Docs",
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chat, talk, approve actions, and share into PASO from iOS.",
      },
      android: {
        title: "Android",
        desc: "Your Android phone as a full PASO device — chat, camera, and Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "The Android companion extends PASO to your watch.",
      },
      macos: {
        title: "macOS",
        desc: "Source-build menu bar companion for notifications, approvals, and quick chat.",
      },
      windows: {
        title: "Windows",
        desc: "Install the PASO CLI and Gateway from source on Windows.",
      },
      linux: {
        title: "Linux",
        desc: "Native desktop companion available now as a source build.",
      },
      chrome: {
        title: "Chrome extension",
        desc: "Let PASO drive your existing Chrome — tabs, pages, and forms.",
      },
      plugins: {
        title: "Plugins & registry",
        desc: "Extend PASO with channels, tools, and skills from the community.",
      },
    },
  },
  presence: {
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "PASO reviews corrections and substantial completed runs, then applies scanner-approved skills and shows them on this board. Experience review spends extra background tokens.",
  ...
  attention: {
    custodianAlertAria: "Ask PASO, {count} undismissed alert",
    custodianAlertsAria: "Ask PASO, {count} undismissed alerts",
  ...
  modelProviders: {
    ...
    readiness: {
      ...
      notConfigured: "Choose a provider and verify the model PASO will use.",
  ...
  login: {
    ...
    failure: {
      ...
      protocol: {
        ...
        stepRestart: "Restart the Gateway after updating PASO so it serves the current protocol.",
      },
      network: {
  ...
  chat: {
    ...
    catalogOpenTargetViewer: "PASO viewer",
    ...
    workspaceConflict: {
      ...
      description:
        "PASO kept your local versions and applied the other cloud changes. Inspect the staged result or take its version for a conflicted path.",
      ...
      commandsUnavailable:
        "This filename contains terminal control characters, so PASO will not build a copyable shell command for it. Inspect the staged ref directly and enter the path manually with care.",
    ...
    progressLabels: {
      ...
      nautiling: "Tracing",
      krilling: "Gathering",
      barnacling: "Anchoring",
      lobstering: "Building",
      tidepooling: "Exploring",
      pearling: "Polishing",
      snapping: "Finalizing",
      surfacing: "Responding",
    },
    turnRecap: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Describe what PASO should do and when — it runs on schedule.",
    ...
    detail: {
      ...
      newSubtitle: "Describe what PASO should do, then pick when it runs.",
    ...
    form: {
      ...
      promptPlaceholder: "Describe what PASO should do...",
      repeat: "Repeat",
